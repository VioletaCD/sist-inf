...
Console.Clear();
// Inicializar datos
Escuela escuela = new Escuela(nombre:"Universidad CDKV SA de CV", encargado:"Ing. Violeta Calderón", domicilio:"Av. de la Juventud 348");
escuela.AgregarProfesor(new Profesor(nombre:"Omar Obviedo", fechaing:DateTime.Parse("1/1/2018"), grupo:"1A", materia:"Fisica", salario:1200));
escuela.AgregarProfesor(new Profesor(nombre:"Daira Guzman", fechaing:DateTime.Parse("10/2/2016"), grupo:"2A", materia:"Algebra", salario:3400));
escuela.AgregarProfesor(new Profesor(nombre:"Ana María Hernandez", fechaing:DateTime.Parse("1/4/2019"), grupo:"4B", materia:"Calculo", salario:3800));
escuela.AgregarProfesor(new Profesor(nombre:"Jaime Camil", fechaing:DateTime.Parse("10/3/2016"), grupo:"8A", materia:"Química", salario:1000));
